...
//       // Navigate to home before scrolling
...
//             <button onClick={() => scrollOrNavigate("features")} className="text-left hover:text-yellow-200">Features</button>
//             <button onClick={() => scrollOrNavigate("solutions")} className="text-left hover:text-yellow-200">Event Solutions</button>
//             <Link to="/pricing" onClick={() => setMenuOpen(false)} className="hover:text-yellow-200">Pricing</Link>
//             <button onClick={() => scrollOrNavigate("about")} className="text-left hover:text-yellow-200">About Us</button>
//             <button onClick={() => scrollOrNavigate("footer")} className="text-left hover:text-yellow-200">Contact</button>
//             <button
//               onClick={() => scrollOrNavigate("footer")}
